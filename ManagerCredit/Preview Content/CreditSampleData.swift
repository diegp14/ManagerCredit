...
extension Credit {
    ...
    static let sampleData: [Credit] = [
        ...
        Credit(id: UUID(), name:"Credito 4" , total: 4_000, status: .active, payDay: 12, creditBalance: 1_000, creditPayment: 3_000, comment: "Comentario 4",
               payments:
                [Payment(id: UUID(), amount: 500, status: .active),
                 Payment(id: UUID(), amount: 500, status: .active),
                 Payment(id: UUID(), amount: 500, status: .cancelled)])
]
}
